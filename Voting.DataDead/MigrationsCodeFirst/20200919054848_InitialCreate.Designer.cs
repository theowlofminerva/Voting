...
using Voting.Data.Models.ModelsCodeFirst;

namespace Voting.Data.MigrationsCodeFirst
{
    [DbContext(typeof(VotingContext))]
    [Migration("20200919054848_InitialCreate")]
            ...
            modelBuilder.Entity("Voting.Data.Models.Office", b =>
                {
                    b.HasOne("Voting.Data.Models.Candidate", "Candidate")
                        .WithOne("Office")
                        .HasForeignKey("Voting.Data.Models.Office", "CandidateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
